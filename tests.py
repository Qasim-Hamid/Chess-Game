...
class TestsBoard(unittest.TestCase):
    ...
    def test_board_init(self):
        ...
        real_board = {1: {Spot('White', Rook('White'), 1, 1), Spot('Black', Knight('White'), 1, 2), Spot('White', Bishop('White'), 1, 3),
                       Spot('Black', Queen('White'), 1, 4), Spot('White', King('White'), 1, 5), Spot('Black', Bishop('White'), 1, 6),
                       Spot('White', Knight('White'), 1, 7), Spot('Black', Rook('White'), 1, 8)},

                      2: {Spot('Black', Pawn('White'), 2, 1), Spot('White', Pawn('White'), 2, 2), Spot('Black', Pawn('White'), 2, 3),
                       Spot('White', Pawn('White'), 2, 4), Spot('Black', Pawn('White'), 2, 5), Spot('White', Pawn('White'), 2, 6),
                       Spot('Black', Pawn('White'), 2, 7), Spot('White', Pawn('White'), 2, 8)},

                      3: {Spot('White', Empty('Blank'), 3, 1), Spot('Black', Empty('Blank'), 3, 2), Spot('White', Empty('Blank'), 3, 3),
                       Spot('Black', Empty('Blank'), 3, 4), Spot('White', Empty('Blank'), 3, 5), Spot('Black', Empty('Blank'), 3, 6),
                       Spot('White', Empty('Blank'), 3, 7), Spot('Black', Empty('Blank'), 3, 8)},

                      4: {Spot('Black', Empty('Blank'), 4, 1), Spot('White', Empty('Blank'), 4, 2), Spot('Black', Empty('Blank'), 4, 3),
                       Spot('White', Empty('Blank'), 4, 4), Spot('Black', Empty('Blank'), 4, 5), Spot('White', Empty('Blank'), 4, 6),
                       Spot('Black', Empty('Blank'), 4, 7), Spot('White', Empty('Blank'), 4, 8)},

                      5: {Spot('White', Empty('Blank'), 5, 1), Spot('Black', Empty('Blank'), 5, 2), Spot('White', Empty('Blank'), 5, 3),
                       Spot('Black', Empty('Blank'), 5, 4), Spot('White', Empty('Blank'), 5, 5), Spot('Black', Empty('Blank'), 5, 6),
                       Spot('White', Empty('Blank'), 5, 7), Spot('Black', Empty('Blank'), 5, 8)},

                      6: {Spot('Black', Empty('Blank'), 6, 1), Spot('White', Empty('Blank'), 6, 2), Spot('Black', Empty('Blank'), 6, 3),
                       Spot('White', Empty('Blank'), 6, 4), Spot('Black', Empty('Blank'), 6, 5), Spot('White', Empty('Blank'), 6, 6),
                       Spot('Black', Empty('Blank'), 6, 7), Spot('White', Empty('Blank'), 6, 8)},

                      7: {Spot('White', Pawn('Black'), 7, 1), Spot('Black', Pawn('Black'), 7, 2), Spot('White', Pawn('Black'), 7, 3),
                       Spot('Black', Pawn('Black'), 7, 4), Spot('White', Pawn('Black'), 7, 5), Spot('Black', Pawn('Black'), 7, 6),
                       Spot('White', Pawn('Black'), 7, 7), Spot('Black', Pawn('Black'), 7, 8)},

                      8: {Spot('Black', Rook('Black'), 8, 1), Spot('White', Knight('Black'), 8, 2), Spot('Black', Bishop('Black'), 8, 3),
                       Spot('White', Queen('Black'), 8, 4), Spot('Black', King('Black'), 8, 5), Spot('White', Bishop('Black'), 8, 6),
                       Spot('Black', Knight('Black'), 8, 7), Spot('White', Rook('Black'), 8, 8)}
                    }
        ...
        for row_index in range(8, 0, -1):
            print("")
            for clmn_index in range(1, 9, 1):
                print("%10s" %generated_board._board[row_index][clmn_index].get_piece(), end=" ")

        #self.assertEqual(generated_board._board, real_board)
'''
...
class TestWhitePawn(unittest.TestCase):
    ...
    @patch('chess_mechanics.input')
    def testPawn(self, mocked_input):
        
        mocked_input.side_effect = [0] 
        #Input when user is asked to move, moves pawn to (3, 4)

        Pawn = self._board.get_spot((2, 4))._piece
        #White Pawn is at (2, 4)

        self._board.get_spot((2, 4)).move_piece(self._board)
        
        self.assertIs(Pawn, self._board.get_spot((3, 4))._piece)
        #Checks if the Pawn object previously at (2,4) is the same object that is now at (3, 4)
...
class TestBlackPawn(unittest.TestCase):
    ...
    def testPawn(self, mocked_input):
        ...
        Pawn = self._board.get_spot((7, 4))._piece
        #Black Pawn is at (7, 4)

        self._board.get_spot((7, 4)).move_piece(self._board)
        
        self.assertIs(Pawn, self._board.get_spot((6, 4))._piece)
        #Checks if the Pawn object previously at (7,4) is the same object that is now at (6, 4)

class TestWhiteRookMove(unittest.TestCase):
    ...
    def testPawn(self, mocked_input):
        ...
        mocked_input.side_effect = [0] 
        #Input when user is asked to move, moves rook to (4, 5)

        self._board.update_board((1, 1), (4, 4), self._board.get_spot((1, 1))._piece)
        #Moves Rook to center of board 

        Rook = self._board.get_spot((4, 4))._piece
        #White Rook is at (4, 4)

        self._board.get_spot((4, 4)).move_piece(self._board)
        
        self.assertIs(Rook, self._board.get_spot((5, 4))._piece)
        #Checks if the Rook object previously at (4,4) is the same object that is now at (5, 4)
